...
export const config = {
  ...
  blockchain: {
    network_name: process.env.NFT_NETWORK_NAME || '',
    chain_id: process.env.NFT_CHAIN_ID ? Number(process.env.NFT_CHAIN_ID) : 0,
    metamask_message: process.env.NFT_METAMASK_MESSAGE || 'TokenSign',
    animverse_nft_address: process.env.NFT_CONTRACT_ADDRESS || '',
